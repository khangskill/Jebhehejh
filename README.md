...
local Window = Rayfield:CreateWindow({
   Name = "HuveisenBesitzer hub",
   LoadingTitle = "Loading...",
   LoadingSubtitle = "by Huveisenbesitzer ",
   ConfigurationSaving = {
      Enabled = true,
   ...
   Discord = {
      Enabled = true,
      Invite = "XtekTm8K", -- The Discord invite code, do not include discord.gg/. E.g. discord.gg/ABCD would be ABCD
      RememberJoins = true -- Set this to false to make them join the discord every time they load it up
   },
   KeySystem = true, -- Set this to true to use our key system
   KeySettings = {
      Title = "HuveisenBesitzer Key",
      Subtitle = "Key System Loaded",
      Note = "Copy Ur URL: discord.gg/mgxFcm2hgW",
      FileName = "Huveisenbesitzer Hub", -- It is recommended to use something unique as other scripts using Rayfield may overwrite your key file
      SaveKey = true, -- The user's key will be saved, but if you change the key, they will be unable to use your script
      GrabKeyFromSite = true, -- If this is true, set Key below to the RAW site you would like Rayfield to get the key from
      Key = {"https://pastebin.com/raw/zsUd3bkF"} -- List of keys that will be accepted by the system, can be RAW file links (pastebin, github etc) or simple strings ("hello","key22")
   }
})

local Main = Window:CreateTab("Home", 8772194322)

local MainScripts = Main:CreateSection("MainScripts")

local InfiniteYield = Main:CreateButton({
   Name = "📝InfiniteYield (Admin Commands)",
   Callback = function()
   loadstring(game:HttpGet('https://raw.githubusercontent.com/EdgeIY/infiniteyield/master/source'))()
   end,
})

local Simplespy = Main:CreateButton({
   Name = "📸Simplespy",
   Callback = function()
   --[[
...
local Games = Window:CreateTab("Games", 11522971436)
local AnimeFightingSimulatorX = Games:CreateSection("💥Anime Fighting Simulator X")

local BloxHub = Games:CreateButton({
   Name = "Blox Hub",
   Callback = function()
...
local AutoStrength = Games:CreateButton({
   Name = "💪Auto Strength",
   Callback = function()
   while wait() do
   game:GetService("ReplicatedStorage").Events["Stats/RemoteFunction"]:InvokeServer("TrainStat","Strength")
    end
   end,
})

local AutoSword = Games:CreateButton({
   Name = "⚔️Auto Sword",
   Callback = function()
   while wait() do
   game:GetService("ReplicatedStorage").Events["Stats/RemoteFunction"]:InvokeServer("TrainStat","Sword")
    end
   end,
})

local AutoDurability = Games:CreateButton({
   Name = "🛡️Auto Durability",
   Callback = function()
   while wait() do
   game:GetService("ReplicatedStorage").Events["Stats/RemoteFunction"]:InvokeServer("TrainStat","Durability")
    end
   end,
})

local AutoChakra = Games:CreateButton({
   Name = "☯️Auto Chakra",
   Callback = function()
   while wait() do
   game:GetService("ReplicatedStorage").Events["Stats/RemoteFunction"]:InvokeServer("TrainStat","Chakra")
    end
   end,
})

local AutoSpeed = Games:CreateButton({
   Name = "🏃‍♂️Auto Speed",
   Callback = function()
   while wait() do
   game:GetService("ReplicatedStorage").Events["Stats/RemoteFunction"]:InvokeServer("TrainStat","Speed")
    end
   end,
})

local RebirthChampionsX = Games:CreateSection("🔄Rebirth Champions X")

local AutoClick = Games:CreateButton({
   Name = "👆Auto Click",
   Callback = function()
   while wait() do
...
local AutoRebirth = Games:CreateButton({
   Name = "🔄Auto Rebirth",
   Callback = function() 
   while wait() do
...
local AutoEggOpen = Games:CreateButton({
   Name = "🥚Auto Egg Open",
   Callback = function()
   while wait() do
   game:GetService("ReplicatedStorage").Functions.Unbox:InvokeServer("Mythic","Triple")
    end
   end,
})

local BloxFruits = Games:CreateSection("🍈BloxFruits")

local NevaHub = Games:CreateButton({
   Name = "Neva Hub",
   Callback = function()
...
local HohoHub = Games:CreateButton({
   Name = "Hoho Hub",
   Callback = function()
...
local MukuroHub = Games:CreateButton({
   Name = "Mukuro Hub",
   Callback = function()
...
local LegendsOfSpeed = Games:CreateSection("⚡Legends Of Speed")

local Vynixius = Games:CreateButton({
   Name = "Vynixius",
   Callback = function()
...
local TheLegendsHub = Games:CreateButton({
...
local UcihaHub = Games:CreateButton({
   Name = "Uciha Hub",
   Callback = function()
...
local DaHood = Games:CreateSection("🔫Da Hood")

local RayX = Games:CreateButton({
   Name = "Ray X",
   Callback = function()
...
local Agent = Games:CreateButton({
   Name = "Agent",
   Callback = function()
...
local SwagMode = Games:CreateButton({
   Name = "Swag Mode",
   Callback = function()
   loadstring(game:HttpGet('https://raw.githubusercontent.com/lerkermer/lua-projects/master/SwagModeV002'))()
   end,
})
local PSX = Games:CreateSection("🐈Pet Simulator X")

local NukeVSCity = Games:CreateButton({
   Name = "Nuke VS City",
   Callback = function()
...
local RaceClicker = Games:CreateSection("🏃‍Race Clicker")

local Saaakai = Games:CreateButton({
   Name = "Saaakai",
   Callback = function()
...
local RaceClicker = Games:CreateButton({
   Name = "RaceClicker (No Name)",
   Callback = function()
   loadstring(game:HttpGet('https://pastebin.com/raw/HecAyid9'))()
   end,
})

local KingLegacy = Games:CreateSection("🍎King Legacy")

local Adel = Games:CreateButton({
   Name = "Adel",
   Callback = function()
...
local NoobHub = Games:CreateButton({
   Name = "Noob Hub",
   Callback = function()
...
local StrikeHub = Games:CreateButton({
   Name = "Strike Hub",
   Callback = function()
